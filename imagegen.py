...
# def generate_and_save_images(prompt, download_folder):
#     # Set the necessary cookies for Bing
#     set_cookies(".bing.com", {
#         "_U": "1-7f5gYThNbKgdNojOXHHoXMJpxPY4jWyDaQ5aoKbUM5uZXWizWY0SuVABgNF4v9GgihUJwq99UQbVJV2X1U0LWvyRLYcF1NiXgCuuH6zQXV3lmHlA5HKlXSdK-KfjzMf1q_mckrehIhfgJ7tLxc1R1lVgHrnEHQmxBRUW8w8_fhgaAJKNjWRb11LKr3D2qmoL9Mp_TvaTcM04KNOTMrCdw"
#     })
...
#             image_path = os.path.join(download_folder, f"image_{i + 1}.jpg")
...
# while True :
#     try :
#         download_folder = os.path.expanduser("Downloads")  # Change this path if necessary
